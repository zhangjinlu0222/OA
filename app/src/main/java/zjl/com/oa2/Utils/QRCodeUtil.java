...
public class QRCodeUtil {
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmapWithLogo(String content, int width, int height,Bitmap mBitmap){
        return createQRCodeBitmapWithLogo(content, width, height,mBitmap, "UTF-8", "H", "2", Color.BLACK, Color.WHITE);
    }
    /**
