...
public class GridImageAdapter extends
    ...
    public GridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener,List<LocalMedia> data) {
        this.context = context;
        mInflater = LayoutInflater.from(context);
        this.mOnAddPicClickListener = mOnAddPicClickListener;
        this.list = data;
    ...
    public void setShowDel( boolean flag) {
        this.showDel = flag;
    }
