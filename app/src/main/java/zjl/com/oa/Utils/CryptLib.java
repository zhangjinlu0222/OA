...
public  class CryptLib {
    ...
    public static String[] GetAndRemoveIV(String encryptedStr, int length)
    {
        ...
        {
            //            ivBuffer.Append(encryptedStr.getBytes()[i]);
            ivBuffer.append(encryptedStr.toCharArray()[i]);
            //            encryptedBuffer.Append(encryptedStr[i - 1]);
            encryptedBuffer.append(encryptedStr.toCharArray()[i - 1]);
        }

        //        iv = ivBuffer.toString();
        //        result = encryptedBuffer.ToString() + encryptedStr.Substring(length * 2);

        result[0] = encryptedBuffer.toString() + encryptedStr.substring(length*2) ;
        result[1] = ivBuffer.toString();
        return result;
    }
    ...
    public static String SHA256 (String text, int length) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        {
            resultStr = result.toString().substring(0, length-1);
        }
