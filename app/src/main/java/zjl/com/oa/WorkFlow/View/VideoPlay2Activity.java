...
public class VideoPlay2Activity extends AppCompatActivity {
    ...
    private void init() {
        ...
        String name = "普通";
        SwitchVideoModel switchVideoModel = new SwitchVideoModel(name, path);

        String name2 = "清晰";
        SwitchVideoModel switchVideoModel2 = new SwitchVideoModel(name2, path);

        List<SwitchVideoModel> list = new ArrayList<>();
        list.add(switchVideoModel);
        list.add(switchVideoModel2);

        videoPlayer.setUp(list, true, "视频");
